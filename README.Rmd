...
The `col` argument lets you colour all the text with one colour, [using ANSI escape codes](https://en.wikipedia.org/wiki/ANSI_escape_code).
...
Here's a screenshot of the output from `cat(hex)` viewed in an R console.
